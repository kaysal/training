...
server:
        ...
        local-data: "${NAME_ONPREM_VM1} A ${RECORD_ONPREM_VM1}"
        local-data: "${NAME_ONPREM_VM2} A ${RECORD_ONPREM_VM2}"
        local-data: "${NAME_ONPREM_VM3} A ${RECORD_ONPREM_VM3}"
...
forward-zone:
        name: "${NAME_LAB}"
        forward-addr: ${FORWARD_LAB_A}
        forward-addr: ${FORWARD_LAB_B}
