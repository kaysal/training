...
resource "google_dns_record_set" "spoke1_vm1_record" {
  project = var.project_id_spoke1
  name    = "vm1.spoke1.lab."
  type    = "A"
  ttl     = 300
  ...
  rrdatas      = [var.spoke1.vm1_ip]
}

resource "google_dns_record_set" "spoke1_vm2_record" {
  project = var.project_id_spoke1
  name    = "vm2.spoke1.lab."
  type    = "A"
  ttl     = 300
...
resource "google_dns_record_set" "spoke2_vm1_record" {
  project = var.project_id_spoke2
  name    = "vm1.spoke2.lab."
  type    = "A"
  ttl     = 300
  ...
  rrdatas      = [var.spoke2.vm1_ip]
}

resource "google_dns_record_set" "spoke2_vm2_record" {
  project = var.project_id_spoke2
  name    = "vm2.spoke2.lab."
  type    = "A"
  ttl     = 300
