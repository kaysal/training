...
data "terraform_remote_state" "gcp_hub_default" {
  backend = "local"
...
locals {
  gcp = {
    gclb_vip           = data.terraform_remote_state.gcp_hub_default.outputs.gclb_vip
    gclb_vip_standard  = data.terraform_remote_state.gcp_hub_default.outputs.gclb_vip_standard
    gclb_vip_premium   = data.terraform_remote_state.gcp_hub_default.outputs.gclb_vip_premium
    mqtt_tcp_proxy_vip = data.terraform_remote_state.gcp_hub_default.outputs.mqtt_tcp_proxy_vip
  }
  aws = {
    tokyo = {
