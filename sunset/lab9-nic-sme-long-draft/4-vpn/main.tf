  ...
  session_config = [
    {
      ...
      cr_bgp_session_range      = "${var.hub.eu.cr_vti1}/30"
      remote_bgp_session_ip     = var.spoke1.eu.cr_vti1
      advertised_route_priority = 100
    },
    {
      session_name              = "${var.hub.prefix}to-spoke1"
      peer_asn                  = var.spoke1.asn
      cr_bgp_session_range      = "${var.hub.eu.cr_vti2}/30"
      remote_bgp_session_ip     = var.spoke1.eu.cr_vti2
      advertised_route_priority = 100
    },
  ]
}
  ...
  session_config = [
    {
      ...
      cr_bgp_session_range      = "${var.spoke1.eu.cr_vti1}/30"
      remote_bgp_session_ip     = var.hub.eu.cr_vti1
      advertised_route_priority = 100
    },
    {
      session_name              = "${var.spoke1.prefix}to-hub"
      peer_asn                  = var.hub.asn
      cr_bgp_session_range      = "${var.spoke1.eu.cr_vti2}/30"
      remote_bgp_session_ip     = var.hub.eu.cr_vti2
      advertised_route_priority = 100
    },
  ]
}
