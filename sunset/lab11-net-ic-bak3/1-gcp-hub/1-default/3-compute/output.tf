...
output "templates" {
  value = {
    ...
    #feeds_asia    = google_compute_instance_template.feeds_asia
    #feeds_eu      = google_compute_instance_template.feeds_eu
    #feeds_us      = google_compute_instance_template.feeds_us
