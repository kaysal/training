...
locals {
  ...
  cloud1 = {
    subnet_self_link  = data.terraform_remote_state.vpc.outputs.vpc.cloud1.subnets.0.self_link
    network_self_link = data.terraform_remote_state.vpc.outputs.vpc.cloud1.network.self_link
  }

  cloud2 = {
    subnet_self_link  = data.terraform_remote_state.vpc.outputs.vpc.cloud2.subnets.0.self_link
    network_self_link = data.terraform_remote_state.vpc.outputs.vpc.cloud2.network.self_link
  }

  cloud3 = {
    subnet_self_link  = data.terraform_remote_state.vpc.outputs.vpc.cloud3.subnets.0.self_link
...
resource "google_compute_instance" "cloud1_vm" {
  ...
  network_interface {
    subnetwork = local.cloud1.subnet_self_link
...
resource "google_compute_instance" "cloud2_vm" {
  ...
  network_interface {
    subnetwork = local.cloud2.subnet_self_link
...
resource "google_compute_instance" "cloud3_vm" {
  ...
  network_interface {
    subnetwork = local.cloud3.subnet_self_link
